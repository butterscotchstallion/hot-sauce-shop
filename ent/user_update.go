...
func (uu *UserUpdate) SetAvatarFilename(s string) *UserUpdate {
	uu.mutation.SetAvatarFilename(s)
	return uu
}

// SetNillableAvatarFilename sets the "avatarFilename" field if the given value is not nil.
func (uu *UserUpdate) SetNillableAvatarFilename(s *string) *UserUpdate {
	if s != nil {
		uu.SetAvatarFilename(*s)
	}
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.AvatarFilename(); ok {
...
// SetAvatarFilename sets the "avatarFilename" field.
func (uuo *UserUpdateOne) SetAvatarFilename(s string) *UserUpdateOne {
	uuo.mutation.SetAvatarFilename(s)
	return uuo
}

// SetNillableAvatarFilename sets the "avatarFilename" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableAvatarFilename(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetAvatarFilename(*s)
	}
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.AvatarFilename(); ok {
		_spec.SetField(user.FieldAvatarFilename, field.TypeString, value)
	}
